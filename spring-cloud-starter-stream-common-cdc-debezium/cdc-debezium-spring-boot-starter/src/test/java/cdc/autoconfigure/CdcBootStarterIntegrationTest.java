...
public class CdcBootStarterIntegrationTest {
	...
	private final JdbcTemplate jdbcTemplate = jdbcTemplate("com.mysql.cj.jdbc.Driver", "jdbc:mysql://localhost:3306/inventory",
			"root", "debezium");
	...
	public void consumerTest() {
		contextRunner
				...
				.run(context -> {
					...
					Thread.sleep(10000);
					assertEquals(53, testConsumer.recordList.size());
				});
	}
