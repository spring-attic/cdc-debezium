...
public class TestCdcApplication {
	...
	public class TestSourceRecordConsumer implements Consumer<SourceRecord> {

		private Function<SourceRecord, byte[]> valueSerializer;
		private Function<SourceRecord, byte[]> keySerializer;
		...
		public void accept(SourceRecord sourceRecord) {
			if (sourceRecord != null) { // ignore null records
				...
				System.out.println("[CDC Event]: " + ((sourceRecord == null) ? "null" : sourceRecord.toString()));
			}
		}
	}
